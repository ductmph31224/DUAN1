                                                    ...
                                                    <form action="">
                                                        <fieldset>
                                                            ...
                                                            <div class="single-input-item">
                                                                <label for="current-pwd" class="required">Mật khẩu cũ
                                                                </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        <label for="new-pwd" class="required">Mật khẩu
                                                                            mới
                                                                        </label>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        <label for="confirm-pwd" class="required">Xác
                                                                            nhận mật khẩu
                                                                        </label>
                                                        ...
                                                        <div class="single-input-item">
                                                            <button class="btn btn-sqr">Lưu thay đổi</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
